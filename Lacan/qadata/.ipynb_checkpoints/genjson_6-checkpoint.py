...
# 设置日志
logging.basicConfig(filename='app6.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
def generate_single_entry(text: str) -> Dict:
    ...
    - 让微调模型具有哲学幽默的能力
    - 将拉康黑话融入幽默文本，生成既“深奥”又带讽刺意味的哲学段子，增强社交趣味性。
    例如：
    {{
      "instruction": "创造一个关于'欲望'的哲学笑话。",
      "input": "欲望",
      "output": "欲望？那不就是你永远得不到的东西，但仍然让你夜不能寐的那个'缺失的对象'吗？"
}}
...
if __name__ == "__main__":
    ...
    output_file = "../datasets/lacan6.json"  # 修改输出文件为JSON格式
