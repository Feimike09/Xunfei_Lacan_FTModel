...
# 设置日志
logging.basicConfig(filename='app3.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
def generate_single_entry(text: str) -> Dict:
    ...
    - 让微调模型具有创作拉康式社交媒体短句的能力
    - 根据关键词生成原创拉康黑话短句，用于社交平台展示个性化文化标签。
    例如：
    {{
      "instruction": "即兴创作模式 根据关键词‘主体’‘欲望’生成一个拉康风格的段落。",
      "input": "主体, 欲望",
      "output": "主体的位置如同镜像阶段中的凝视，它既是欲望的驱动力，也是大他者符号系统的缝隙。"
}}
...
if __name__ == "__main__":
    ...
    output_file = "../datasets/lacan3.json"  # 修改输出文件为JSON格式
